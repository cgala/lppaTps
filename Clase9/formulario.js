...
function valTelefono(e){
  ...
  formulario.addEventListener("submit",valForm);

  function valForm(e){
    // e.preventDefault();
    var terminos = document.getElementById('terminos');
    if(estados.nombre && estados.edad && estados.direccion && estados.ciudad && estados.postal && estados.dni && estados.password && estados.correo && estados.telefono && terminos.checked){
